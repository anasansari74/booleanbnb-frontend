...
import { Props, Apartment } from "../App";

import AirBnbLogo from "../assets/images/logo.png";
function OneApartment(props) {
  ...
  function loadingExtras(apartment: any) {
    if (apartment.extra === undefined) {
      return <li>Loading Extras</li>;
    } else {
      return (
        <ul>
          {apartment.extra.smartTV ? (
            <li>
              Smart TV <CgScreen className="icon" />
            </li>
          ) : (
            <li>
              Smart TV <CgScreen className="icon greyOut" />
            </li>
          )}
          {apartment.extra.garden ? (
            <li>
              Garden <GiGrass className="icon" />
            </li>
          ) : (
            <li>
              Garden <GiGrass className="icon greyOut" />
            </li>
          )}
          {apartment.extra.gym ? (
            <li>
              Gym <GiGymBag className="icon" />
            </li>
          ) : (
            <li>
              Gym <GiGymBag className="icon greyOut" />
            </li>
          )}
          {apartment.extra.hotTub ? (
            <li>
              HotTub <FaHotTub className="icon" />
            </li>
          ) : (
            <li>
              HotTub <FaHotTub className="icon greyOut" />
            </li>
          )}
          {apartment.extra.microwave ? (
            <li>
              MicroWave <GiCookingPot className="icon" />
            </li>
          ) : (
            <li>
              MicroWave <GiCookingPot className="icon greyOut" />
            </li>
          )}
          {apartment.extra.parkingSpace ? (
            <li>
              Parking Space
            ...
            <li>
              Parking Space <FaParking className="icon greyOut" />
            </li>
          )}
          {apartment.extra.pool ? (
            <li>
              Swimming Pool
            ...
            <li>
              Swimming Pool <FaSwimmingPool className="icon greyOut" />
            </li>
          )}
          {apartment.extra.wifi ? (
            <li>
              Wifi
            ...
            <li>
              Wifi <FaWifi className="icon greyOut" />
            </li>
          )}
        </ul>
      );
      ...
      <main className={props.className}>
        ...
        <section className="airBnbInformationSection">
          <div className="extras">
            <div>{loadingExtras(apartment)}</div>
          </div>
